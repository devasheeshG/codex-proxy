...
This note documents the backend compose service behavior in the Codex Proxy. It is intentionally small so operators and contributors can find one decision without searching the entire README.
